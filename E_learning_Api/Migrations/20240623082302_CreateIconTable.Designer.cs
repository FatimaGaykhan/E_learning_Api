...
namespace E_learning_Api.Migrations
{
    ...
    [Migration("20240623082302_CreateIconTable")]
            ...
            modelBuilder.Entity("E_learning_Api.Models.About", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 6, 23, 12, 23, 2, 470, DateTimeKind.Local).AddTicks(4000),
            ...
            modelBuilder.Entity("E_learning_Api.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 6, 23, 12, 23, 2, 470, DateTimeKind.Local).AddTicks(4010),
                            Image = "cat-1.jpg",
                            Name = "Web Design",
                            SoftDeleted = false
                        },
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 6, 23, 12, 23, 2, 470, DateTimeKind.Local).AddTicks(4020),
                            Image = "cat-2.jpg",
                            Name = "Graphic Design",
                            SoftDeleted = false
                        },
            ...
            modelBuilder.Entity("E_learning_Api.Models.Icon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 6, 23, 12, 23, 2, 470, DateTimeKind.Local).AddTicks(4050),
                            SoftDeleted = false
                        },
                        new
                        {
            ...
            modelBuilder.Entity("E_learning_Api.Models.Slider", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 6, 23, 12, 23, 2, 470, DateTimeKind.Local).AddTicks(3940),
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 6, 23, 12, 23, 2, 470, DateTimeKind.Local).AddTicks(3950),
                            Description = "Vero elitr justo clita lorem. Ipsum dolor at sed stet sit diam no. Kasd rebum ipsum et diam justo clita et kasd rebum sea sanctus eirmod elitr.",
